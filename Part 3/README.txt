This is the README file for Part 3 of our project of creating a database for the "XYZ Gym".

The objectives for this stage were to write SQL statements to search for and retrieve information from the database and to write a python program to connect to the SQLite database and execute SQL queries. 
